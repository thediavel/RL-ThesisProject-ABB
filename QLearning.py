...
class qLearning:
    def __init__(self, learningRate, decayRate, numOfEpisodes, stepsPerEpisode, epsilon ,annealingConstant, annealAfter):
        ...
        self.states=['v:' + x + ';l:' + y for x in self.voltageRanges_2 for y in self.loadingPercentRange]
    ...
    def getStateFromMeasurements(self, voltageLoadingPercent):
        ...
        return 'v:'+self.voltageRanges[v_ind]+';l:'+self.loadingPercentRange[l_ind];

    def getStateFromMeasurements_2(self, voltageLoadingPercent):
        voltage=voltageLoadingPercent[0];
        loadingPercent=voltageLoadingPercent[1];
        ...
        l_ind = (math.floor(round(loadingPercent)/10));
        l_ind = l_ind if l_ind < len(self.loadingPercentRange) else len(self.loadingPercentRange)-1;
        return 'v:'+self.voltageRanges_2[v_ind]+';l:'+self.loadingPercentRange[l_ind];
    ...
    def test(self):
        ...
        for i in range(0,0):
            ...
            currentState = self.getStateFromMeasurements_2(currentMeasurements);
            ...
            for i in range(0,self.numOfEpisodes):
                ...
                for j in range(0,self.numOfSteps):
                    ...
                    if done:
                        ...
                        nextState = self.getStateFromMeasurements_2(nextStateMeasurements);
